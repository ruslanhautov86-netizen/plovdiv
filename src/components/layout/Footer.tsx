...
export function Footer() {
  return (
    <footer className="bg-graphite-light border-t border-black/5 pt-16 pb-8" id="contacts">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Contacts Column */}
          <div className="space-y-4">
            <h4 className="text-lg font-heading font-bold text-foreground mb-6">Контакты</h4>
          ...
          {/* Hours Column */}
          <div className="space-y-4">
            <h4 className="text-lg font-heading font-bold text-foreground mb-6">Режим работы</h4>
            <div className="flex items-start gap-3 text-foreground/70 text-sm">
              <Clock className="text-gold shrink-0 mt-1" size={18} />
              <div>
                <p className="mb-2"><strong className="text-foreground">Вс - Чт:</strong> 12:00 - 23:00</p>
                <p><strong className="text-foreground">Пт - Сб:</strong> 12:00 - 02:00</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-heading font-bold text-foreground mb-6">Мы на карте</h4>
            <div className="w-full h-32 bg-background rounded-lg border border-black/5 flex items-center justify-center relative overflow-hidden group">
        ...
        <div className="border-t border-black/5 pt-8 text-center text-sm text-foreground/50">
