...
export function Events() {
  return (
    <section id="events" className="py-24 bg-graphite-light border-t border-white/5">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="space-y-8">
            <h3 className="text-3xl font-heading font-bold text-white mb-4">Незабываемые вечера</h3>
            ...
            <div className="bg-background rounded-lg p-6 border border-white/5 shadow-xl relative overflow-hidden group">
              <div className="absolute top-0 left-0 w-1 h-full bg-gold" />
              <div className="flex justify-between items-center mb-2">
                <span className="text-gold font-bold text-lg">Пятница и Суббота</span>
                <span className="bg-white/10 text-white px-3 py-1 rounded-full text-xs uppercase tracking-wider">Живой звук</span>
              </div>
              <h4 className="text-xl font-bold text-white mb-2">Танцевальные вечера и Дискотека</h4>
          ...
          {/* Banquet Form */}
          <div className="bg-background rounded-xl p-8 lg:p-10 border border-white/5 shadow-2xl relative">
            <div className="absolute -top-6 -right-6 w-32 h-32 bg-gold/10 rounded-full blur-2xl z-0" />
            <div className="relative z-10">
              <h3 className="text-2xl font-heading font-bold text-white mb-2">Организация банкета</h3>
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input 
                    ...
                    className="bg-white/5 border border-white/10 rounded-md px-4 py-3 text-foreground placeholder:text-foreground/40 focus:outline-none focus:border-gold transition-colors"
                  />
                  <input 
                    type="tel" 
